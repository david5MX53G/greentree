...
public class Token implements Serializable {
     ...
     * you override the auto-generated column name." (skaffman, 2011, https://stackoverflow.com/questions/4662582/make-hibernate-ignore-class-variables-that-are-not-mapped)
    */
    ...
    public Token(String passphrase) throws TokenException {
        ...
        logger.debug("keyPair: " + pair.toString());
        
        this.privateKey = (RSAPrivateKey) pair.getPrivate();
        logger.debug("privateKey: " + privateKey.toString());
        
        this.publicKey = (RSAPublicKey) pair.getPublic();
        logger.debug("publicKey: " + publicKey.getAlgorithm());
