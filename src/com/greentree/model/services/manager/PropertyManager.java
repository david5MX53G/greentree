...
public class PropertyManager extends DefaultHandler  {
    ...
    /**
     * This XML file will be parsed with {@link javax.xml.parsers.SAXParser} 
     * and resulting properties stored in a {@link java.util.Properties} object.
     */
    private static final String PROPSPATH = "config/application.properties.xml";
    ...
    /**
     * This loads properties from {@link PropertyManager#PROPSPATH}.
     *
     * @throws IOException when the file at <code>PROPSPATH</code> cannot be 
     * read
     * 
        ...
        throws SAXException
    {
        ...
        if (qName.equals("minpoolsize")) {
            eleName = "jdbc.minpoolsize";
            eleVal = BUFFER.toString().trim();
            LOG.debug(eleName + ": " + eleVal);
            properties.setProperty(eleName, eleVal);
        }
