...
public class ServiceFactory {
	...
	/** Creates a new <code>ServiceFactory</code> using the Singleton Gang of Four Pattern */
	private ServiceFactory() {}
	
	/**
	 * Implements the Singleton Gang of Four pattern because multiple <code>ServiceFactory</code> 
	 * objects is wasteful
	 * 
	...
	/** 
	 * @param name {@link String} used to search the properties file for name of the correct 
	 *   service implementation class 
	 * @return {@link IService} implementation class corresponding with the given <code>name</code>
	 * @throws ServiceLoadException when the named service cannot be found in the properties file
	 */
	...
	/** 
	 * @return fully-qualified name of a com.greetree.model.services implementation class
	 * @throws IOException 
	 * @name used to look up the fully-qualified class in <code>application.properties</code>
	 */
