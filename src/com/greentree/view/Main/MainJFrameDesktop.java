...
public class MainJFrameDesktop extends JFrame {
	...
	/** This is used for log messaging. */
	String logPfx;
	
	/** 
	 * {@link JDesktopPane} that contains {@link JInternalFrame} objects added by {@Link 
	...
	/** 
	 * implements a new {@link MainJInternalFrame} object without a controller. Pass the new <code>
	...
	public MainJFrameDesktop() {		
        ...
        System.out.println(this.logPfx + ": instantiated successfully");
	}
    ...
    /** @return {@link JMenuItem} "Open" for opening a log to view messages therein */
    public JMenuItem getLogMI() {
    	return this.logMI;
    }
    
    /** 
     * set up an empty {@link JMenuBar} with a {@link JMenu}, add {@link JMenuItem} objects to it,
     * and return the result. Each menu item has an action command {@link String} referenced in 
     * the {@link MainJFrameController}.
     *  
